 ...
 *   https://datatables.net/download/#dt/dt-1.11.4/date-1.1.2/rg-1.1.4/rr-1.2.8/sb-1.3.1/sp-1.4.0
 *
 * Included libraries:
 *   DataTables 1.11.4, DateTime 1.1.2, RowGroup 1.1.4, RowReorder 1.2.8, SearchBuilder 1.3.1, SearchPanes 1.4.0
 */
...
(function(l) {
    ...
    u.ext = M = {
        buttons: {},
        classes: {},
        build: "dt/dt-1.11.4/date-1.1.2/rg-1.1.4/rr-1.2.8/sb-1.3.1/sp-1.4.0",
        errMode: "alert",
        feature: [],
        search: [],
        selector: {
    ...
    b.extend(k.prototype, {
        ...
        _rowWrap: function(a, f, h) {
            ...
            return a === g || null === a ? null :
                ("object" === typeof a && a.nodeName && "tr" === a.nodeName.toLowerCase() ? b(a) : a instanceof b && a.length && "tr" === a[0].nodeName.toLowerCase() ? a : b("<tr/>").append(b("<td/>").attr("colspan", this._colspan()).append(a))).addClass(this.c.className).addClass(f).addClass("dtrg-level-" + h)
        }
    });
    k.defaults = {
    ...
    var h, p, t = window.moment,
        ...
        r = function() {
            function c(a, b, d, e, f) {
                ...
                this.dom = {
                    ...
                    right: h("<button/>").html(this.s.dt.i18n("searchBuilder.right", b.right)).addClass(this.classes.right).addClass(this.classes.button).attr("title", this.s.dt.i18n("searchBuilder.rightTitle", b.rightTitle)).attr("type",
                        "button"),
            ...
            c.prototype.getDetails = function(a) {
                ...
                if (null !== this.s.type && this.s.type.includes("num") && ("" !== this.s.dt.settings()[0].oLanguage.sDecimal || "" !== this.s.dt.settings()[0].oLanguage.sThousands))
                    ...
                    for (a = 0; a < this.s.value.length; a++) this.s.value[a] = t(this.s.value[a], this.s.dateFormat).toISOString();
            ...
            c.prototype.setListeners = function() {
                ...
                this.dom.data.unbind("change").on("change.dtsb", function() {
                    ...
                    for (var b = a.dom.data.children("option." + a.classes.option), d = 0; d < b.length; d++) {
                        var e = h(b[d]);
                        e.val() === a.dom.data.val() ? (a.dom.data.removeClass(a.classes.italic), e.prop("selected", !0), a.s.dataIdx = +e.val(), a.s.data = e.text(), a.s.origData = e.prop("origData"), a.c.orthogonal = a._getOptions().orthogonal, a._clearCondition(), a._clearValue(), a._populateCondition(), a.s.filled && (a.s.filled = !1, a.s.dt.draw(), a.setListeners()),
                ...
                this.dom.condition.unbind("change").on("change.dtsb", function() {
                    ...
                    for (var b = a.dom.condition.children("option." + a.classes.option), d = 0; d < b.length; d++) {
                        var e = h(b[d]);
                        if (e.val() === a.dom.condition.val()) {
                            ...
                            e = 0;
                            for (f =
                                a.dom.value; e < f.length; e++) g = f[e], a.s.filled && void 0 !== g && 0 !== a.dom.container.has(g[0]).length && (a.s.filled = !1, a.s.dt.draw(), a.setListeners());
                            (0 === a.dom.value.length || 1 === a.dom.value.length && void 0 === a.dom.value[0]) && a.s.dt.draw()
            ...
            c.prototype._adjustCriteria = function() {
                if (0 !== h(document).has(this.dom.container).length) {
                    ...
                    if (void 0 !== a && 0 !== this.dom.container.has(a[0]).length) {
                        ...
                        (15 > q - a || g && d.top !== f.top || n && e.top !== f.top) && !this.dom.container.parent().hasClass(this.classes.vertical) ? (this.dom.container.parent().addClass(this.classes.vertical), this.s.topGroup.trigger("dtsb-redrawContents")) : 15 < q - (this.dom.data.offset().left + this.dom.data.outerWidth(!0) + this.dom.condition.outerWidth(!0) +
            ...
            c.prototype._populateCondition = function() {
                ...
                if (0 === b) {
                    ...
                    "" !== b && this.s.type.indexOf(b) === this.s.type.length - b.length && (this.s.type.includes("num-fmt") ? this.s.type = this.s.type.replace(b, "") : this.s.type.includes("num") && (this.s.type = this.s.type.replace(b, "")));
                    ...
                    for (this.dom.condition.empty().removeAttr("disabled").addClass(this.classes.italic), e = 0, f = Object.keys(this.s.conditions); e < f.length; e++) d = f[e], b = this.s.conditions[d].conditionName, "function" === typeof b && (b = b(this.s.dt, this.c.i18n)), d = h("<option>", {
                            text: b,
                            value: d
                        }).addClass(this.classes.option).addClass(this.classes.notItalic), void 0 !== this.s.condition && this.s.condition === b && (d.prop("selected", !0), this.dom.condition.removeClass(this.classes.italic)),
                        a.push(d);
                else {
                ...
                if (0 === this.s.dataPoints.length) this.s.dt.columns().every(function(g) {
                    ...
                    for (var b = function(g) {
                                d.s.dt.columns().every(function(q) {
                                    var u =
                                        a.s.dt.settings()[0].aoColumns[q];
                                    (void 0 === u.searchBuilderTitle ? u.sTitle : u.searchBuilderTitle).replace(/(<([^>]+)>)/ig, "") === g.text && (g.index = q, g.origData = u.data)
                                });
                                var n = h("<option>", {
            ...
            c.prototype._populateValue = function(a) {
                ...
                void 0 !== this.dom.value[0] && this.dom.value[0].insertAfter(this.dom.condition).trigger("dtsb-inserted");
            ...
            c.initSelect = function(a, b, d, e) {
                ...
                var q = h("<select/>").addClass(c.classes.value).addClass(c.classes.dropDown).addClass(c.classes.italic).addClass(c.classes.select).append(a.dom.valueTitle).on("change.dtsb", function() {
                ...
                for (var u = [], D = [], H = 0; H < g.length; H++) {
                    var z = g[H],
                        A = n.oApi._fnGetCellData(n, z, f, "string" === typeof a.c.orthogonal ? a.c.orthogonal : a.c.orthogonal.search);
                    A = "string" === typeof A ? A.replace(/[\r\n\u2028]/g, " ") : A;
                    z = n.oApi._fnGetCellData(n,
                        z, f, "string" === typeof a.c.orthogonal ? a.c.orthogonal : a.c.orthogonal.display);
                    "array" === a.s.type && (A = Array.isArray(A) ? A : [A], z = Array.isArray(z) ? z : [z]);
                    var J = function(w, y) {
                        a.s.type.includes("html") && null !== w && "string" === typeof w && w.replace(/(<([^>]+)>)/ig, "");
                        w = h("<option>", {
                            type: Array.isArray(w) ? "Array" : "String",
                            value: w
                        }).data("sbv", w).addClass(a.classes.option).addClass(a.classes.notItalic).html("string" === typeof y ? y.replace(/(<([^>]+)>)/ig, "") : y);
                        y = w.val(); - 1 === u.indexOf(y) && (u.push(y), D.push(w), null !==
                    ...
                    if (e)
                        for (var F = 0; F < A.length; F++) J(A[F], z[F]);
                    else J(A, Array.isArray(z) ? z.join(", ") : z)
                }
                D.sort(function(w, y) {
                    if ("array" === a.s.type || "string" === a.s.type || "html" === a.s.type) return w.val() < y.val() ? -1 : w.val() > y.val() ? 1 : 0;
                    if ("num" === a.s.type || "html-num" === a.s.type) return +w.val().replace(/(<([^>]+)>)/ig, "") < +y.val().replace(/(<([^>]+)>)/ig,
                        "") ? -1 : +w.val().replace(/(<([^>]+)>)/ig, "") > +y.val().replace(/(<([^>]+)>)/ig, "") ? 1 : 0;
            ...
            c.init2Input = function(a, b, d) {
                ...
                e = [h("<input/>").addClass(c.classes.value).addClass(c.classes.input).on("input.dtsb keypress.dtsb", a._throttle(function(f) {
                    f = f.keyCode || f.which;
                    if (!(a.c.enterSearch || void 0 !== a.s.dt.settings()[0].oInit.search && a.s.dt.settings()[0].oInit.search["return"]) || 13 === f) return b(a, this)
                }, null === e ? 100 : e)), h("<span>").addClass(a.classes.joiner).html(a.s.dt.i18n("searchBuilder.valueJoiner", a.c.i18n.valueJoiner)), h("<input/>").addClass(c.classes.value).addClass(c.classes.input).on("input.dtsb keypress.dtsb",
                    a._throttle(function(f) {
                        f = f.keyCode || f.which;
                        if (!(a.c.enterSearch || void 0 !== a.s.dt.settings()[0].oInit.search && a.s.dt.settings()[0].oInit.search["return"]) || 13 === f) return b(a, this)
                    }, null === e ? 100 : e))];
            ...
            c.init2Date = function(a, b, d) {
                ...
                f = [h("<input/>").addClass(c.classes.value).addClass(c.classes.input).dtDateTime({
                    ...
                    return b(a,
                        this)
                }, f)), h("<span>").addClass(a.classes.joiner).html(a.s.dt.i18n("searchBuilder.valueJoiner", a.c.i18n.valueJoiner)), h("<input/>").addClass(c.classes.value).addClass(c.classes.input).dtDateTime({
                    attachTo: "input",
                    format: a.s.dateFormat ? a.s.dateFormat : void 0
                }).on("change.dtsb", null !== f ? a.s.dt.settings()[0].oApi._fnThrottle(function() {
                    return b(a, this)
            ...
            c.isInputValidSelect =
                function(a) {
                    for (var b = !0, d = 0; d < a.length; d++) {
                        var e = a[d];
                        e.children("option:selected").length === e.children("option").length - e.children("option." + c.classes.notItalic).length && 1 === e.children("option:selected").length && e.children("option:selected")[0] === e.children("option")[0] && (b = !1)
                    }
                    return b
                };
            ...
            c.updateListener = function(a, b) {
                ...
                if (a.s.filled) {
                    ...
                    for (d = 0; d < a.s.value.length; d++)
                        ...
                        else if (a.s.type.includes("num") &&
                        ("" !== a.s.dt.settings()[0].oLanguage.sDecimal || "" !== a.s.dt.settings()[0].oLanguage.sThousands)) {
                    ...
                    f = e = null;
                    for (d = 0; d < a.dom.value.length; d++) b === a.dom.value[d][0] && (e = d, void 0 !== b.selectionStart &&
                        (f = b.selectionStart));
                    a.s.dt.draw();
        ...
        B, E, G = function() {
            ...
            c.prototype.rebuild = function(a) {
                if (!(void 0 === a.criteria || null === a.criteria || Array.isArray(a.criteria) && 0 === a.criteria.length)) {
                    ...
                    this.dom.logic.children().first().html("OR" === this.s.logic ? this.s.dt.i18n("searchBuilder.logicOr",
            ...
            c.prototype._setCriteriaListeners = function(a) {
                ...
                a.dom.right.unbind("click").on("click.dtsb", function() {
                    var d = a.s.index,
                        e = new c(b.s.dt, b.s.opts,
                            b.s.topGroup, a.s.index, !0, b.s.depth + 1);
                    e.addCriteria(a);
            ...
            c.prototype._setup = function() {
                this.setListeners();
                this.dom.add.html(this.s.dt.i18n("searchBuilder.add",
                    this.c.i18n.add));
        ...
        x, C, I = function() {
            function c(a, b) {
                ...
                this.dom = {
                    clearAll: x('<button type="button">' + a.i18n("searchBuilder.clearAll", this.c.i18n.clearAll) + "</button>").addClass(this.classes.clearAll).addClass(this.classes.button).attr("type", "button"),
                ...
                if (void 0 === a.settings()[0]._searchBuilder) {
                    ...
                    if (this.s.dt.page.info().serverSide) this.s.dt.on("preXhr.dtsb", function(e, f, g) {
            ...
            c.prototype._applyPreDefDefaults =
                function(a) {
                    var b = this;
                    void 0 !== a.criteria && void 0 === a.logic && (a.logic = "AND");
                    for (var d = function(n) {
                            void 0 !== n.criteria ? n = e._applyPreDefDefaults(n) : e.s.dt.columns().every(function(q) {
            ...
            c.prototype._setUp = function(a) {
                ...
                a && (a = this.s.dt.state.loaded(), null !== a && void 0 !== a.searchBuilder ? (this.s.topGroup.rebuild(a.searchBuilder), this.s.topGroup.dom.container.trigger("dtsb-redrawContents"), this.s.dt.page.info().serverSide || this.s.dt.page(a.page).draw("page"), this.s.topGroup.setListeners()) : !1 !== this.c.preDefined && (this.c.preDefined =
                    this._applyPreDefDefaults(this.c.preDefined), this.rebuild(this.c.preDefined)));
            ...
            c.prototype._setRedrawListener =
                function() {
                    var a = this;
...
$jscomp.checkEs6ConformanceViaProxy = function() {
    try {
        var n = {},
            q = Object.create(new $jscomp.global.Proxy(n, {
                get: function(l, r, t) {
                    return l == n && "q" == r && t == q
                }
            }));
...
$jscomp.SIMPLE_FROUND_POLYFILL = !1;
$jscomp.ISOLATE_POLYFILLS = !1;
$jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function(n, q, l) {
...
$jscomp.polyfill = function(n, q, l, r) {
    q && ($jscomp.ISOLATE_POLYFILLS ? $jscomp.polyfillIsolated(n, q, l, r) : $jscomp.polyfillUnisolated(n, q, l, r))
};
$jscomp.polyfillUnisolated = function(n, q, l, r) {
    ...
    r = l[n];
    q = q(r);
    q != r && null != q && $jscomp.defineProperty(l, n, {
        configurable: !0,
        writable: !0,
        value: q
    })
...
$jscomp.polyfillIsolated = function(n, q, l, r) {
    ...
    q = q(l);
    null != q && (n ? $jscomp.defineProperty($jscomp.polyfills, t, {
        configurable: !0,
        writable: !0,
        value: q
    }) : q !== l && ($jscomp.propertyToPolyfillSymbol[t] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(t) : $jscomp.POLYFILL_PREFIX + t, t =
        $jscomp.propertyToPolyfillSymbol[t], $jscomp.defineProperty(r, t, {
            configurable: !0,
            writable: !0,
            value: q
        })))
...
$jscomp.polyfill("Symbol.iterator", function(n) {
        ...
        for (var q = "Array Int8Array Uint8Array Uint8ClampedArray Int16Array Uint16Array Int32Array Uint32Array Float32Array Float64Array".split(" "), l = 0; l < q.length; l++) {
            var r = $jscomp.global[q[l]];
            "function" === typeof r && "function" != typeof r.prototype[n] && $jscomp.defineProperty(r.prototype, n, {
                configurable: !0,
                writable: !0,
                value: function() {
                    return $jscomp.iteratorPrototype($jscomp.arrayIteratorImpl(this))
...
$jscomp.polyfill("Map", function(n) {
    function q() {
        if ($jscomp.ASSUME_NO_NATIVE_MAP || !n || "function" != typeof n || !n.prototype.entries || "function" != typeof Object.seal) return !1;
        try {
            var h = Object.seal({
                    x: 4
                }),
                a = new n($jscomp.makeIterator([
                    [h, "s"]
                ]));
    ...
    var t = function(h, a) {
            var b = a && typeof a;
            "object" == b || "function" == b ? l.has(a) ? b = l.get(a) :
                (b = "" + ++F, l.set(a, b)) : b = "p_" + a;
            var c = h.data_[b];
...
$jscomp.polyfill("Object.is", function(n) {
    return n ? n : function(q, l) {
        return q === l ? 0 !== q || 1 / q === 1 / l : q !== q && l !== l
    }
}, "es6", "es3");
$jscomp.polyfill("Array.prototype.includes", function(n) {
    return n ? n : function(q, l) {
        var r = this;
...
$jscomp.checkStringArgs = function(n, q, l) {
    if (null == n) throw new TypeError("The 'this' value for String.prototype." + l + " must not be null or undefined");
    if (q instanceof RegExp) throw new TypeError("First argument to String.prototype." + l + " must not be a regular expression");
    return n + ""
};
$jscomp.polyfill("String.prototype.includes", function(n) {
    return n ? n : function(q, l) {
        return -1 !== $jscomp.checkStringArgs(this, q, "includes").indexOf(q, l || 0)
    }
}, "es6", "es3");
$jscomp.polyfill("Array.prototype.findIndex", function(n) {
    return n ? n : function(q, l) {
...
(function() {
    ...
    var l, r, t = function() {
            function h(a, b, c, e, d, f) {
                ...
                this.dom = {
                    ...
                    collapseButton: l('<button type="button"><span class="dtsp-caret">&#x5e;</span></button>').addClass(this.classes.paneButton).addClass(this.classes.collapseButton),
                    container: l("<div/>").addClass(this.classes.container).addClass(this.classes.layout + (10 > b ? e : e.split("-")[0] + "-9")),
                    ...
                    searchButton: l('<button type = "button" class="' + this.classes.searchIcon + '"></button>').addClass(this.classes.paneButton),
                ...
                this.dom.container.addClass(null !== this.customPaneSettings && void 0 !== this.customPaneSettings.className ?
                ...
                this.s.searchFunction = function(m, x, z, y) {
                    ...
                    m = null;
                    g.colExists && (m = x[g.s.index], "filter" !== k.orthogonal.filter &&
                        (m = g.s.rowData.filterMap.get(z), m instanceof l.fn.dataTable.Api && (m = m.toArray())));
                    return g._search(m, z)
                };
                l.fn.dataTable.ext.search.push(this.s.searchFunction);
                if (this.c.clear) e.on("click", function() {
            ...
            h.prototype.addRow = function(a, b, c, e, d, f, g) {
                ...
                void 0 === k && (k = this.s.indexes.length, this.s.indexes.push({
                    filter: b,
                    index: k
                }));
            ...
            h.prototype.collapse = function() {
                var a = this;
                this.s.displayed && (this.c.collapse || !0 === this.s.colOpts.collapse) && !1 !== this.s.colOpts.collapse && (this.dom.collapseButton.addClass(this.classes.rotated),
            ...
            h.prototype.emptyMessage = function() {
                ...
                !1 !== this.s.colOpts.emptyMessage && null !== this.s.colOpts.emptyMessage &&
            ...
            h.prototype.rebuildPane = function(a, b, c, e) {
                ...
                this.s.serverSelect = [];
                var f = null;
                void 0 !== this.s.dtPane && (e && (this.s.dt.page.info().serverSide ? this.s.serverSelect = this.s.dtPane.rows({
                        selected: !0
                    }).data().toArray() :
                    d = this.s.dtPane.rows({
                        selected: !0
                    }).data().toArray()), this.s.dtPane.clear().destroy(), f = this.dom.container.prev(), this.destroy(), this.s.dtPane = void 0, l.fn.dataTable.ext.search.push(this.s.searchFunction));
            ...
            h.prototype.resize = function(a) {
                ...
                this.dom.container.removeClass().addClass(this.classes.container).addClass(this.classes.layout + (10 > b ? a : a.split("-")[0] + "-9")).addClass(this.s.colOpts.className).addClass(null !== this.customPaneSettings && void 0 !== this.customPaneSettings.className ? this.customPaneSettings.className : "").addClass(this.classes.show);
                this.adjustTopRow()
            };
            ...
            h.prototype._setListeners = function() {
                ...
                this.s.dtPane.on("select.dtsp", function() {
                    ...
                    a.s.dt.page.info().serverSide && !a.s.updating ? a.s.serverSelecting || (a.s.serverSelect = a.s.dtPane.rows({
                            selected: !0
                        }).data().toArray(), a.s.scrollTop = l(a.s.dtPane.table().node()).parent()[0].scrollTop,
                        a.s.selectPresent = !0, a.s.dt.draw(!1)) : a.s.updating || (a.s.selectPresent = !0, a._makeSelection(), a.s.selectPresent = !1);
                ...
                this.s.dtPane.on("deselect.dtsp", function() {
                    c = setTimeout(function() {
                        ...
                        a.s.dt.page.info().serverSide && !a.s.updating ? a.s.serverSelecting || (a.s.serverSelect = a.s.dtPane.rows({
                            selected: !0
                        }).data().toArray(), a.s.deselect = !0, a.s.dt.draw(!1)) : (a.s.deselect = !0, a._makeSelection(), a.s.deselect = !1);
                        0 === a.s.dtPane.rows({
                            selected: !0
                        }).data().toArray().length && a.dom.clear.addClass(a.classes.disabledButton).attr("disabled", "true")
                    }, 50)
                });
                this.s.firstSet && (this.s.firstSet = !1, this.s.dt.on("stateSaveParams.dtsp", function(e, d, f) {
                    if (l.isEmptyObject(f)) a.s.dtPane.state.clear();
                        ...
                        for (d = 0; d < f.searchPanes.panes.length; d++) f.searchPanes.panes[d].id === a.s.index && (f.searchPanes.panes.splice(d, 1), d--);
                ...
                this.s.dtPane.on("user-select.dtsp",
                    function(e, d, f, g, k) {
                        k.stopPropagation()
                    });
                ...
                this.dom.collapseButton.on("click.dtsp", function(e) {
                    ...
                    if (e.hasClass(a.classes.hidden)) a.dom.topRow.on("click",
                        function() {
                ...
                this.dom.searchBox.on("input.dtsp", function() {
                    ...
                    "string" === typeof e && (0 < e.length || 0 === e.length && 0 < a.s.dtPane.rows({
                        selected: !0
                    }).data().toArray().length) ? a.dom.clear.removeClass(a.classes.disabledButton).removeAttr("disabled") : a.dom.clear.addClass(a.classes.disabledButton).attr("disabled", "true");
                    a.s.dt.state.save()
                });
                return !0
            };
            h.prototype._addOption = function(a, b, c, e, d, f) {
                if (Array.isArray(a) || a instanceof r.Api)
                    if (a instanceof r.Api && (a = a.toArray(), b = b.toArray()), a.length === b.length)
                        for (var g = 0; g <
                            a.length; g++) f[a[g]] ? f[a[g]]++ : (f[a[g]] = 1, d.push({
                            display: b[g],
                            filter: a[g],
                            sort: c[g],
                            type: e[g]
                ...
                else "string" === typeof this.s.colOpts.orthogonal ? (f[a] ? f[a]++ : (f[a] = 1, d.push({
                    display: b,
                    filter: a,
                    sort: c,
                    type: e
                })), this.s.rowData.totalOptions++) : d.push({
                    display: b,
                    filter: a,
                    sort: c,
                    type: e
            ...
            h.prototype._buildPane = function(a, b, c, e, d) {
                    ...
                    if (y && y.searchPanes && y.searchPanes.panes)
                        for (var u = 0; u < y.searchPanes.panes.length; u++)
                            if (y.searchPanes.panes[u].id === this.s.index) {
                                w = u;
                                break
                            } if ((!1 === p.show || void 0 !== p.show &&
                            !0 !== p.show) && -1 === w) return this.dom.container.addClass(this.classes.hidden), this.s.displayed = !1;
                    if (!0 === p.show || -1 !== w) this.s.displayed = !0;
                    if (!this.s.dt.page.info().serverSide && (null === c || null === c.searchPanes || null === c.searchPanes.options)) {
                        0 === m.arrayFilter.length && (this._populatePane(b), this.s.rowData.totalOptions = 0, this._detailsPane(), m.arrayOriginal = m.arrayTotals, m.binsOriginal = m.binsTotal);
                        u = Object.keys(m.binsOriginal).length;
                        b = this._uniqueRatio(u, g.rows()[0].length);
                        if (!1 === this.s.displayed &&
                            ((void 0 === p.show && null === p.threshold ? b > this.c.threshold : b > p.threshold) || !0 !== p.show && 1 >= u)) {
                        ...
                        if (void 0 !== c.searchPanes.options[b])
                            for (u = 0, b = c.searchPanes.options[b]; u < b.length; u++) w = b[u], this.s.rowData.arrayFilter.push({
                                    ...
                                    sort: w.label,
                                    type: w.label
                                }), this.s.rowData.bins[w.value] = this.c.viewTotal || this.c.cascadePanes ? w.count : w.total, this.s.rowData.binsTotal[w.value] =
                                w.total;
                ...
                this._displayPane();
                if (!this.s.listSet) this.dom.dtP.on("stateLoadParams.dt",
                    function(C, G, D) {
                        l.isEmptyObject(g.state.loaded()) && l.each(D, function(E, I) {
                            delete D[E]
                        })
                    });
                null !== d && 0 < this.dom.panesContainer.has(d).length ? this.dom.container.insertAfter(d) : this.dom.panesContainer.prepend(this.dom.container);
                u = l.fn.dataTable.ext.errMode;
                l.fn.dataTable.ext.errMode = "none";
                d = r.Scroller;
                this.s.dtPane = this.dom.dtP.DataTable(l.extend(!0, {
                    columnDefs: [{
                        ...
                        render: function(C, G, D) {
                            ...
                            var E = (f.s.filteringActive ||
                                f.s.showFiltered) && f.c.viewTotal || f.c.viewTotal && f.s.forceViewTotal ? z.replace(/{total}/, D.total) : x.replace(/{total}/, D.total);
                            for (E = E.replace(/{shown}/, D.shown); E.includes("{total}");) E = E.replace(/{total}/, D.total);
                            for (; E.includes("{shown}");) E = E.replace(/{shown}/, D.shown);
                            D = '<span class="' + f.classes.pill + '">' + E + "</span>";
                            f.c.viewCount && p.viewCount || (D = "");
                            return "filter" === G ? "string" === typeof C && null !== C.match(/<[^>]*>/) ? C.replace(/<[^>]*>/g, "") : C : '<div class="' + f.classes.nameCont + '"><span title="' +
                ...
                }, null !== this.customPaneSettings && void 0 !== this.customPaneSettings.dtOpts ? this.customPaneSettings.dtOpts : {}, l.fn.dataTable.versionCheck("2") ? {
                    layout: {
                        bottomLeft: null,
                        bottomRight: null,
                        topLeft: null,
                ...
                d = "Custom Pane";
                this.customPaneSettings && this.customPaneSettings.header ? d = this.customPaneSettings.header : p.header ? d = p.header : this.colExists && (d = l.fn.dataTable.versionCheck("2") ? g.column(this.s.index).title() : g.settings()[0].aoColumns[this.s.index].sTitle);
                ...
                if (this.colExists) {
                    ...
                    for (d = m.arrayFilter.length; u < d; u++) {
                        k = !1;
                        w = 0;
                        for (var H = this.s.serverSelect; w < H.length; w++) b = H[w], b.filter === m.arrayFilter[u].filter && (k = !0);
                        if (this.s.dt.page.info().serverSide && (!this.c.cascadePanes || this.c.cascadePanes && 0 !== m.bins[m.arrayFilter[u].filter] || this.c.cascadePanes && null !== e || k))
                            for (k = this.addRow(m.arrayFilter[u].display, m.arrayFilter[u].filter, e ? m.binsTotal[m.arrayFilter[u].filter] : m.bins[m.arrayFilter[u].filter], this.c.viewTotal || e ? String(m.binsTotal[m.arrayFilter[u].filter]) : m.bins[m.arrayFilter[u].filter],
                                    m.arrayFilter[u].sort, m.arrayFilter[u].type), w = 0, H = this.s.serverSelect; w < H.length; w++) b = H[w], b.filter === m.arrayFilter[u].filter && (this.s.serverSelecting = !0, k.select(), this.s.serverSelecting = !1);
                        else this.s.dt.page.info().serverSide || !m.arrayFilter[u] || void 0 === m.bins[m.arrayFilter[u].filter] && this.c.cascadePanes ? this.s.dt.page.info().serverSide || this.addRow("", B, B, "", "", "") : this.addRow(m.arrayFilter[u].display, m.arrayFilter[u].filter, m.bins[m.arrayFilter[u].filter], m.binsTotal[m.arrayFilter[u].filter],
                ...
                for (e = 0; e < a.length; e++)
                    if (m = a[e], void 0 !== m)
                        for (u = 0, d = this.s.dtPane.rows().indexes().toArray(); u < d.length; u++) k = d[u], void 0 !== this.s.dtPane.row(k).data() &&
                            m.filter === this.s.dtPane.row(k).data().filter && (this.s.dt.page.info().serverSide ? (this.s.serverSelecting = !0, this.s.dtPane.row(k).select(), this.s.serverSelecting = !1) : this.s.dtPane.row(k).select());
                this.s.dt.page.info().serverSide && this.s.dtPane.search(this.dom.searchBox.val()).draw();
                (this.c.initCollapsed && !1 !== this.s.colOpts.initCollapsed || this.s.colOpts.initCollapsed) && (this.c.collapse && !1 !== this.s.colOpts.collapse || this.s.colOpts.collapse) && this.collapse();
                if (y && y.searchPanes && y.searchPanes.panes &&
                    (null === c || 1 === c.draw))
                    for (this.c.cascadePanes || this._reloadSelect(y), c = 0, y = y.searchPanes.panes; c < y.length; c++) a = y[c], a.id === this.s.index && (a.searchTerm && 0 < a.searchTerm.length && (this.dom.searchBox.val(a.searchTerm), this.dom.searchBox.trigger("input")), this.s.dtPane.order(a.order).draw(), a.collapsed ? this.collapse() : this.show());
                return !0
            };
            ...
            h.prototype._displayPane = function() {
                ...
                this.c.clear && this.c.controls && b.controls && this.dom.clear.appendTo(this.dom.buttonGroup);
                this.c.orderable && b.orderable && this.c.controls && b.controls && this.dom.nameButton.appendTo(this.dom.buttonGroup);
                this.c.viewCount && b.viewCount && this.c.orderable && b.orderable && this.c.controls && b.controls && this.dom.countButton.appendTo(this.dom.buttonGroup);
                (this.c.collapse && !1 !== this.s.colOpts.collapse || this.s.colOpts.collapse) && this.c.controls && b.controls && this.dom.collapseButton.appendTo(this.dom.buttonGroup);
                this.dom.topRow.prependTo(this.dom.container);
                a.append(this.dom.dtP);
                a.show()
            };
            h.prototype._getBonusOptions = function() {
                return l.extend(!0, {}, h.defaults, {
                    orthogonal: {
                        threshold: null
                    },
                    threshold: null
            ...
            h.prototype._populatePane = function(a) {
                ...
                if (!this.s.dt.page.info().serverSide) {
                    ...
                    for (a = (!this.c.cascadePanes && !this.c.viewTotal || this.s.clearing || a ? b.rows().indexes() : b.rows({
                            search: "applied"
                        }).indexes()).toArray(); e < a.length; e++) this._populatePaneArray(a[e], this.s.rowData.arrayFilter, c)
                }
            };
            h.prototype._populatePaneArray = function(a, b, c, e) {
                void 0 === e && (e = this.s.rowData.bins);
                var d = this.s.colOpts;
                if ("string" === typeof d.orthogonal) c = c.oApi._fnGetCellData(c, a, this.s.index, d.orthogonal), this.s.rowData.filterMap.set(a, c), this._addOption(c, c, c, c, b, e);
                else {
                    ...
                    e[f] ? e[f]++ : (e[f] = 1, this._addOption(f, c.oApi._fnGetCellData(c, a, this.s.index, d.orthogonal.display), c.oApi._fnGetCellData(c, a, this.s.index, d.orthogonal.sort),
                        c.oApi._fnGetCellData(c, a, this.s.index, d.orthogonal.type), b, e));
                    this.s.rowData.totalOptions++
                }
            };
            ...
            h.prototype._search = function(a, b) {
                for (var c = this.s.colOpts, e = this.s.dt, d = 0, f = this.selections; d < f.length; d++) {
                    var g = f[d];
                    "string" === typeof g.filter && "string" === typeof a && (g.filter = g.filter.replace(/&amp;/g, "&").replace(/&lt;/g, "<").replace(/&gt;/g, ">").replace(/&quot;/g, '"'));
                    if (Array.isArray(a)) {
            ...
            h.prototype._searchExtras = function() {
                ...
                var b = this.s.dtPane.rows({
                    ...
                    e = l(this.s.dtPane.table().container()); - 1 < c && (b[c] = "");
                0 < b.length ? e.addClass(this.classes.selected) : 0 === b.length && e.removeClass(this.classes.selected);
                this.s.updating = a
            };
                ...
                if (!(this.s.dt.page.info().serverSide || void 0 === this.s.dtPane || this.s.filteringActive && !this.c.cascadePanes && !0 !== a || !0 === this.c.cascadePanes && !0 === this.s.selectPresent || this.s.lastSelect && this.s.lastCascade)) {
                    ...
                    if (this.colExists) {
                        0 === c.arrayFilter.length ? this._populatePane(!this.s.filteringActive) : this.c.cascadePanes && this.s.dt.rows().data().toArray().length === this.s.dt.rows({
                            search: "applied"
                        }).data().toArray().length ? (c.arrayFilter = c.arrayOriginal, c.bins = c.binsOriginal) : (this.c.viewTotal || this.c.cascadePanes) && this._populatePane(!this.s.filteringActive);
                        this.c.viewTotal ? this._detailsPane() : c.binsTotal = c.bins;
                        this.c.viewTotal && !this.c.cascadePanes && (c.arrayFilter = c.arrayTotals);
                        for (var e = function(k) {
                                if (k && (void 0 !== c.bins[k.filter] && 0 !== c.bins[k.filter] && d.c.cascadePanes || !d.c.cascadePanes || d.s.clearing)) {
                                    var p = d.addRow(k.display, k.filter, d.c.viewTotal ? void 0 !== c.bins[k.filter] ? c.bins[k.filter] : 0 : c.bins[k.filter], d.c.viewTotal ? String(c.binsTotal[k.filter]) : c.bins[k.filter], k.sort, k.type),
                                        m = b.findIndex(function(x) {
                                            return x.filter === k.filter
                                        }); - 1 !== m && (p.select(), b.splice(m, 1))
                                }
                            }, d = this, f = 0, g = c.arrayFilter; f < g.length; f++) e(g[f])
                    }
                    if (void 0 !== a.searchPanes && void 0 !== a.searchPanes.options ||
                        void 0 !== a.options || null !== this.customPaneSettings && void 0 !== this.customPaneSettings.options)
                        for (e = function(k) {
                                var p = b.findIndex(function(m) {
                                    if (m.display === k.data().display) return !0
                                }); - 1 !== p && (k.select(), b.splice(p, 1))
                            }, f = 0, g = this._getComparisonRows(); f < g.length; f++) a = g[f], e(a);
                    for (e = 0; e < b.length; e++) a = b[e], a = this.addRow(a.display, a.filter, 0, this.c.viewTotal ? a.total : 0, a.display, a.display), this.s.updating = !0, a.select(), this.s.updating = !1;
                    this.s.dtPane.draw();
        ...
        v, A, F = function() {
            function h(a, b, c) {
                ...
                this.dom = {
                    ...
                    collapseAll: v('<button type="button">Collapse All</button>').addClass(this.classes.collapseAll),
                    container: v("<div/>").addClass(this.classes.panes).text(d.i18n("searchPanes.loadMessage",
                    ...
                    showAll: v('<button type="button">Show All</button>').addClass(this.classes.showAll).addClass(this.classes.disabledButton).attr("disabled", "true"),
                ...
                if (void 0 === d.settings()[0]._searchPanes) {
                    this._getState();
                    if (this.s.dt.page.info().serverSide) d.on("preXhr.dt", function(f, g, k) {
                    ...
                    d.on("xhr", function(f, g, k, p) {
                        k && k.searchPanes && k.searchPanes.options && (e.s.serverData = k, e.s.serverData.tableLength = k.recordsTotal, e._serverTotals())
                    });
                    d.settings()[0]._searchPanes = this;
                    this.dom.clearAll.text(d.i18n("searchPanes.clearMessage", this.c.i18n.clearMessage));
                    this.dom.collapseAll.text(d.i18n("searchPanes.collapseMessage", this.c.i18n.collapseMessage));
                    this.dom.showAll.text(d.i18n("searchPanes.showMessage",
                        this.c.i18n.showMessage));
                    if (this.s.dt.settings()[0]._bInitComplete || c) this._paneDeclare(d, a, b);
                    else d.one("preInit.dt", function(f) {
            ...
            h.prototype.rebuild = function(a, b) {
                ...
                for (var e = 0, d = this.s.panes; e < d.length; e++) {
                    var f = d[e];
                    if (!1 === a || f.s.index === a) f.clearData(), c.push(f.rebuildPane(void 0 !== this.s.selectionList[this.s.selectionList.length - 1] ? f.s.index === this.s.selectionList[this.s.selectionList.length - 1].index : !1, this.s.dt.page.info().serverSide ? this.s.serverData : void 0, null, b)), this.dom.panes.append(f.dom.container)
                }
                this.c.cascadePanes ||
            ...
            h.prototype.redrawPanes = function(a) {
                ...
                if (!this.s.updating && !this.s.dt.page.info().serverSide) {
                    for (var c = !0, e = this.s.filterPane, d = null, f = 0, g = this.s.panes; f < g.length; f++) {
                        var k = g[f];
                        void 0 !== k.s.dtPane && (d += k.s.dtPane.rows({
                            selected: !0
                        }).data().toArray().length)
                    }
                    if (0 === d && b.rows({
                        ...
                        b.rows().data().toArray().length) c = !1;
                    ...
                    if (this.regenerating)
                        for (f = -1, 1 === b.length && null !== d && 0 !== d && (f = b[0].index), a = 0, b = this.s.panes; a < b.length; a++) {
                            if (k =
                                b[a], void 0 !== k.s.dtPane) {
                                g = !0;
                                k.s.filteringActive = !0;
                                if (-1 !== e && null !== e && e === k.s.index || !1 === c || k.s.index === f) g = !1, k.s.filteringActive = !1;
                                k.updatePane(g ? c : g)
                            }
                        } else {
                            g = 0;
                            for (p = this.s.panes; g < p.length; g++)
                                if (k = p[g], k.s.selectPresent) {
                                    ...
                                    break
                                } else k.s.deselect && (f = k.s.index, m = k.s.dtPane.rows({
                                    selected: !0
                                }).data().toArray(), 0 < m.length && this.s.selectionList.push({
                                    index: k.s.index,
                                    protect: !0,
                                    rows: m
                                }));
                            if (0 < this.s.selectionList.length)
                                for (g = this.s.selectionList[this.s.selectionList.length - 1].index, p = 0, m = this.s.panes; p < m.length; p++) k = m[p], k.s.lastSelect = k.s.index === g;
                            for (k = 0; k < this.s.selectionList.length; k++)
                                if (this.s.selectionList[k].index !== f || !0 === this.s.selectionList[k].protect) {
                                    g = !1;
                                    for (p = k + 1; p < this.s.selectionList.length; p++) this.s.selectionList[p].index === this.s.selectionList[k].index && (g = !0);
                            ...
                            for (m = this.s.panes; p < m.length; p++)
                                ...
                                for (this._cascadeRegen(b, d), g = b[b.length - 1].index, e = 0, a = this.s.panes; e < a.length; e++) k = a[e], k.s.lastSelect = k.s.index === g;
                            else if (0 < b.length)
                                for (k = 0, a = this.s.panes; k < a.length; k++)
                                    if (b = a[k], void 0 !== b.s.dtPane) {
                                        g = !0;
                                        b.s.filteringActive = !0;
                                        if (-1 !== e && null !== e && e === b.s.index || !1 === c || b.s.index === f) g = !1, b.s.filteringActive = !1;
                                        b.updatePane(g ? c : g)
                                    }
                        }
                    this._updateFilterCount();
            ...
            h.prototype.resizePanes = function() {
                if ("auto" === this.c.layout) {
                    ...
                    e =
                        0 !== c ? e.slice(e.length - c, e.length) : [];
                    b = 0;
                    for (d = this.s.panes; b < d.length; b++) g = d[b], g.s.displayed && (f = "columns-" + (e.includes(g.s.index) ? c : a), g.resize(f))
                } else
                    for (a = 0, c = this.s.panes; a < c.length; a++) g = c[a], g.adjustTopRow();
                return this
            };
            h.prototype._attach = function() {
                ...
                for (var b = 0, c = this.s.panes; b < c.length; b++) c[b].dom.container.appendTo(this.dom.panes);
            ...
            h.prototype._attachExtras = function() {
                ...
                this.dom.title.appendTo(this.dom.titleRow);
                this.c.clear && this.dom.clearAll.appendTo(this.dom.titleRow);
                this.c.collapse && (this.dom.showAll.appendTo(this.dom.titleRow), this.dom.collapseAll.appendTo(this.dom.titleRow));
                this.dom.titleRow.appendTo(this.dom.container);
                return this.dom.container
            };
            h.prototype._attachMessage = function() {
                ...
                if (null === a) this.dom.container.addClass(this.classes.hide),
                    this.dom.titleRow.removeClass(this.classes.hide);
                else return this.dom.container.removeClass(this.classes.hide), this.dom.titleRow.addClass(this.classes.hide), this.dom.emptyMessage.text(a), this.dom.emptyMessage.appendTo(this.dom.container), this.dom.container
            };
            ...
            h.prototype._cascadeRegen = function(a, b) {
                ...
                var c = -1;
                1 === a.length &&
                    null !== b && 0 !== b && (c = a[0].index);
                for (var e = 0, d = this.s.panes; e < d.length; e++) b = d[e], b.setCascadeRegen(!0), b.setClear(!0), (void 0 !== b.s.dtPane && b.s.index === c || void 0 !== b.s.dtPane) && b.clearPane(), b.setClear(!1);
                this.s.dt.draw();
                c = this.s.dt.rows({
                    search: "applied"
                }).data().toArray().length;
            ...
            h.prototype._checkCollapse = function() {
                for (var a = !0, b = !0, c = 0, e = this.s.panes; c < e.length; c++) {
                    var d =
                        e[c];
                    d.s.displayed && (d.dom.collapseButton.hasClass(d.classes.rotated) ? (this.dom.showAll.removeClass(this.classes.disabledButton).removeAttr("disabled"), b = !1) : (this.dom.collapseAll.removeClass(this.classes.disabledButton).removeAttr("disabled"), a = !1))
                }
                            ...
                            if (f.s.index === a[b].index && void 0 !== f.s.dtPane) {
                                ...
                                for (var g = function(m) {
                                        ...
                                        f.s.dtPane.rows().every(function(z) {
                                            void 0 !== f.s.dtPane.row(z).data() && void 0 !== m && f.s.dtPane.row(z).data().filter === m.filter && (x = !0, f.s.dtPane.row(z).select())
                                        });
                                        x || f.addRow(m.display, m.filter, 0, m.total, m.sort, m.type, m.className).select()
                                    }, k = 0, p = a[b].rows; k < p.length; k++) g(p[k]);
            ...
            h.prototype._paneDeclare =
                function(a, b, c) {
                    var e = this;
                    a.columns(0 < this.c.columns.length ? this.c.columns : void 0).eq(0).each(function(k) {
                        e.s.panes.push(new t(b, c, k, e.c.layout, e.dom.panes))
                    });
                    for (var d = a.columns().eq(0).toArray().length, f = this.c.panes.length, g = 0; g < f; g++) this.s.panes.push(new t(b, c, d + g, this.c.layout, this.dom.panes, this.c.panes[g]));
                    if (0 < this.c.order.length)
                        for (d = this.c.order.map(function(k, p, m) {
                                return e._findPane(k)
                            }), this.dom.panes.empty(), this.s.panes = d, d = 0, f = this.s.panes; d < f.length; d++) this.dom.panes.append(f[d].dom.container);
            ...
            h.prototype._serverTotals = function() {
                ...
                if (a) {
                    ...
                    for (e = 0; e < this.s.selectionList.length; e++) {
                        d = !1;
                        for (a = e + 1; a < this.s.selectionList.length; a++) this.s.selectionList[a].index === this.s.selectionList[e].index && (d = !0);
                        if (!d) {
                            a = !1;
                            for (var f = 0, g = this.s.panes; f < g.length; f++) d = g[f], d.s.index === this.s.selectionList[e].index && 0 < d.s.dtPane.rows({
                                selected: !0
                            }).data().toArray().length && (a = !0);
                ...
                if (b && 1 === this.s.selectionList.length)
                    for (b = 0, e = this.s.panes; b < e.length; b++) d = e[b], d.s.lastSelect = !1, d.s.deselect = !1, void 0 !== d.s.dtPane && 0 < d.s.dtPane.rows({
                        selected: !0
                    }).data().toArray().length && (c = d.s.index);
                else if (0 < this.s.selectionList.length)
                    for (b = this.s.selectionList[this.s.selectionList.length - 1].index, e = 0, a = this.s.panes; e < a.length; e++) d = a[e], d.s.lastSelect = d.s.index === b, d.s.deselect = !1;
                else if (0 ===
                    this.s.selectionList.length)
                    for (b = 0, e = this.s.panes; b < e.length; b++) d = e[b], d.s.lastSelect = !1, d.s.deselect = !1;
                this.dom.panes.empty();
                b = 0;
                for (e = this.s.panes; b < e.length; b++) d = e[b], d.s.lastSelect ? d._setListeners() : d.rebuildPane(void 0, this.s.dt.page.info().serverSide ? this.s.serverData : void 0, d.s.index === c ? !0 : null, !0), this.dom.panes.append(d.dom.container), void 0 !== d.s.dtPane && (v(d.s.dtPane.table().node()).parent()[0].scrollTop = d.s.scrollTop, v.fn.dataTable.select.init(d.s.dtPane));
            ...
            h.prototype._setCollapseListener = function() {
                ...
                for (var b = 0, c = this.s.panes; b < c.length; b++) c[b].dom.collapseButton.on("click", function() {
            ...
            h.prototype._startup = function(a) {
                ...
                if (this.c.viewTotal && !this.c.cascadePanes && null !== c && void 0 !== c &&
                    void 0 !== c.searchPanes && void 0 !== c.searchPanes.panes) {
                ...
                e = 0;
                for (d = this.s.panes; e < d.length; e++) g = d[e], g.rebuildPane(void 0, 0 < Object.keys(this.s.serverData).length ? this.s.serverData : void 0), this.dom.panes.append(g.dom.container);
                ...
                a.on("preDraw.dtsps", function() {
                    b.s.updating || b.s.paging || (!b.c.cascadePanes && !b.c.viewTotal || b.s.dt.page.info().serverSide ? (b._updateFilterCount(), b._updateSelection()) : b.redrawPanes(b.c.viewTotal), b.s.filterPane = -1);
                    b.s.paging = !1
                });
                v(window).on("resize.dtsp", A.util.throttle(function() {
                    b.resizePanes()
                }));
                ...
                if (this.s.dt.page.info().serverSide) a.off("preXhr.dt"), a.on("preXhr.dt", function(k, p, m) {
                    void 0 === m.searchPanes && (m.searchPanes = {});
                    ...
                    for (var x = b.s.panes; p < x.length; p++) {
                        ...
                        if (void 0 !== z.s.dtPane) {
                            ...
                            for (var w = 0; w < z.length; w++) m.searchPanes[y][w] = z[w].filter, null === m.searchPanes[y][w] && (m.searchPanes_null[y][w] = !0), k++
                        }
                    }
                    b.c.viewTotal && b._prepViewTotal(k);
                    0 < k && (k !== b.s.filterCount ? (m.start = 0, b.s.page = 0) : m.start = b.s.page * b.s.dt.page.len(), b.s.dt.page(b.s.page), b.s.filterCount = k)
                });
                else a.on("preXhr.dt", function(k, p, m) {
                    k = 0;
                ...
                for (e = this.s.panes; c < e.length; c++)
                    if (g = e[c], void 0 !== g && void 0 !== g.s.dtPane && (void 0 !== g.s.colOpts.preSelect && 0 < g.s.colOpts.preSelect.length || null !== g.customPaneSettings && void 0 !== g.customPaneSettings.preSelect && 0 < g.customPaneSettings.preSelect.length)) {
                        d = g.s.dtPane.rows().data().toArray().length;
                        for (f = 0; f < d; f++)(g.s.colOpts.preSelect.includes(g.s.dtPane.cell(f, 0).data()) || null !== g.customPaneSettings && void 0 !== g.customPaneSettings.preSelect && g.customPaneSettings.preSelect.includes(g.s.dtPane.cell(f, 0).data())) && g.s.dtPane.row(f).select();
                        g.updateTable()
                    } if (void 0 !== this.s.selectionList && 0 < this.s.selectionList.length)
                    for (c = this.s.selectionList[this.s.selectionList.length - 1].index, e = 0, d = this.s.panes; e < d.length; e++) g = d[e], g.s.lastSelect = g.s.index === c;
                0 < this.s.selectionList.length && this.c.cascadePanes &&
            ...
            h.prototype._prepViewTotal = function(a) {
                ...
                for (e = this.s.panes; a < e.length; a++)
                    if (f = e[a], void 0 !== f.s.dtPane && (f.s.filteringActive = !0, -1 !== b && null !== b && b === f.s.index || !1 === c)) f.s.filteringActive = !1
            };
    ...
    (function(h) {
        ...
        h.fn.dataTable.ext.buttons.searchPanes = {
            ...
            config: {},
            init: function(d, f, g) {
                var k = new h.fn.dataTable.SearchPanes(d, h.extend({
                        filterChanged: function(m) {
                            d.button(f).text(d.i18n("searchPanes.collapse", void 0 !== d.context[0].oLanguage.searchPanes ? d.context[0].oLanguage.searchPanes.collapse : d.context[0]._searchPanes.c.i18n.collapse, m))
                        }
                    }, g.config)),

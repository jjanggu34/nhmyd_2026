...
$(document).ready(function(){
	...
	$('.guide_button > a').click(function(){
		$('body').addClass('nhd_sbnew').removeClass('nhd_allone').removeClass('nhd_pay');
		if($(this).attr('class') == 'btn_sw02') $('body').addClass('nhd_allone').removeClass('nhd_sbnew').removeClass('nhd_pay');
		else if($(this).attr('class') == 'btn_sw03') $('body').addClass('nhd_pay').removeClass('nhd_sbnew').removeClass('nhd_allone');
